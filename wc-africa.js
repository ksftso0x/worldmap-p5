...
let hh = 620; // window.innerHeight; // ww * ratio;
var layerCnt = 5;
var stepsLayer = 50;
var pp = [[-200, -200], [200, -150], [0, -200], [-100, -100], [200, 150]];
...
function preload() {
    imgMask = loadImage('assets/africa.png');
}
...
function draw() {
  ...
  for (fcn = 0; fcn < layerCnt; fcn++) {
      myLayers[fcn] = new Array(stepsLayer).fill().map((x, i) => deform(poly(random(200, 300), noise(i) * 30), 8, 0.5));
      layerLen += stepsLayer;
  }
